                  ...
                  <div class="mb-3">
                    <div class="relative">
                      ...
                      <input
                        ...
                        class="pl-10 bg-white text-black border-0 rounded-md p-2 w-full focus:outline-none focus:ring-1 focus:ring-blue-500 transition ease-in-out duration-150 @error('name') ring-2 ring-error @enderror"
                        type="name"
                        name="name"
                        id="name"
                        required
